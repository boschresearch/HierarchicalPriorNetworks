...
parser.add_argument('config_bl', type=str, help='Path to baseline config file.')  # 256
parser.add_argument('config_patch1', type=str, help='Path to patch config file.')  # 128
parser.add_argument('config_patch2', type=str, help='Path to patch config file.')  # 64
parser.add_argument('config_patch3', type=str, help='Path to patch config file.')  # 32
parser.add_argument('config_patch4', type=str, help='Path to patch config file.')  # 16
...
for it, (data_bl, data_patch, data_patch2, data_patch3, data_patch4) in enumerate(
    ...
    vg_local4, _ = get_valuegrid_patch(data_patch4, patch_setting4)
    combined = (vg_local + vg_local2 + vg_local3 + vg_local4 + vg_global) / 5
