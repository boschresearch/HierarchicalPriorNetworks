...
class Trainer(BaseTrainer):
    ...
    def eval_step(self, data):
        ...
        # valid = data.get('points.valid').cpu().numpy()
    ...
    def compute_loss(self, data):
        ...
        distance_weight = torch.abs(sdf)
        distance_weight = 1-distance_weight
        # normalize each batch element
        distance_weight /= torch.unsqueeze(distance_weight.sum(dim=1), 1)
        ...
        occ = occ[valid_mask]
        # no weighting according to distance to surface
